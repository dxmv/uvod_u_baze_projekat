...
public class FutureSessionsView extends VBox {
    ...
    private ObservableList<Seansa> allFutureSessions;

    public FutureSessionsView(Stage stage, Scene previousScene, int therapistId) {
        this.stage = stage;
        ...
        Label titleLabel = new Label("Buduće seanse");
        ...
        List<Seansa> futureSessions = getFutureSessionsWithClientInfo(therapistId);
        allFutureSessions = FXCollections.observableArrayList(futureSessions);
        table.setItems(allFutureSessions);
    ...
    private List<Seansa> getFutureSessionsWithClientInfo(int therapistId) {
        List<Seansa> futureSessions = seansaRepository.getFutureSessions(therapistId);
        Map<Integer, Klijent> klijentMap = new HashMap<>();

        for (Seansa seansa : futureSessions) {
    ...
    private void filterSessionsByDate() {
        ...
        for (Seansa seansa : allFutureSessions) {
