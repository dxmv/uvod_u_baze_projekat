...
public class TherapistProfileView {
    ...
    public TherapistProfileView(Stage stage, Psychotherapist psychotherapist) {
        this.stage = stage;
        initializeUI(psychotherapist);
    }

    private void initializeUI(Psychotherapist therapist) {
